...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-pharmacy-purple/10 to-white pt-6 pb-8 md:py-16">
        ...
        <div className="grid gap-4 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-3 md:space-y-4 animate-fade-in order-2 lg:order-1">
            <div className="space-y-2">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tighter text-pharmacy-dark-purple">
                Sua saúde em primeiro lugar
              </h1>
              <p className="text-sm md:text-base text-muted-foreground md:text-xl">
                Medicamentos e produtos de saúde com a qualidade que você merece.
                {!isMobile && " Entrega rápida e segura na sua casa."}
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              <Button size={isMobile ? "sm" : "lg"} className="bg-pharmacy-purple hover:bg-pharmacy-dark-purple" asChild>
                <Link to="/categories">
          ...
          <div className="relative block order-1 lg:order-2">
            <div className="relative mx-auto aspect-[4/3] overflow-hidden rounded-xl bg-gradient-to-tr from-pharmacy-purple/20 to-pharmacy-green/20 flex items-center justify-center">
              <img
